                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    controller: profile.nameController
                                      ..text = profile.name
                                      ..selection = TextSelection.collapsed(offset: profile.nameController.text.length),
                                  ...
                                  TextFormField(
                                    ...
                                    controller: profile.emailController
                                      ..text = profile.email
                                      ..selection = TextSelection.collapsed(offset: profile.emailController.text.length),
                                    decoration: InputDecoration(
                                      errorBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(8.r),
                                        borderSide: BorderSide(
                                  ...
                                  TextFormField(
                                    ...
                                    controller: profile.phoneController
                                      ..text = profile.mobile
                                      ..selection = TextSelection.collapsed(offset: profile.phoneController.text.length),
                                  ...
                                  TextFormField(
                                    ...
                                    controller: profile.addressController
                                      ...
                                      ..selection = TextSelection.collapsed(offset: profile.addressController.text.length),
                                    decoration: InputDecoration(
                                      errorBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(8.r),
                                    ...
                                    children: [
                                      ElevatedButton(
                                        ...
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: kMainColor,
                                          minimumSize: Size(MediaQuery.of(context).size.width * .90, 48.w),
