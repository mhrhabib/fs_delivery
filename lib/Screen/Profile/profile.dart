                                      ...
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            ProfileCard(
                                              page: false,
                                              topic: 'balance'.tr,
                                              amount: ' ${Get.find<GlobalController>().currency!} ${profile.profileUser.currentBalance.toString()}',
                                              imgUrl: Images.logo,
                                            ...
                                            ProfileCard(
                                              page: true,
                                              topic: "earning".tr,
                                              amount: ' ${Get.find<GlobalController>().currency!} ${profile.profileUser.deliverymanEarn.toString()}',
                                              imgUrl: Images.logo,
                                            ...
                                            ProfileCard(
                                              page: true,
                                              topic: "total_cod".tr,
                                              amount: ' ${Get.find<GlobalController>().currency!}${profile.profileUser.totalCod.toString()}',
                                              imgUrl: Images.logo,
...
class Tracker extends StatelessWidget {
  const Tracker({Key? key, required this.trackNo, required this.track}) : super(key: key);
