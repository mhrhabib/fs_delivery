          ...
          builder: (controller) => Padding(
                ...
                child: Column(
                  children: [
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20),
                                color: active == true ? kMainColor : Colors.transparent,
                              ),
                              child: Center(
                                  child: Text(
                                'income'.tr,
                                style: TextStyle(
                                  color: active == true ? kBgColor : Colors.grey,
                                  fontSize: 14,
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20),
                                color: active == true ? Colors.transparent : kMainColor,
                              ),
                              child: Center(
                                  child: Text(
                                'expense'.tr,
                                style: TextStyle(
                                  color: active == true ? Colors.grey : kBgColor,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
                                ),
                              )),
                    ...
                    /// data section
                    controller.loader ? PaymentLogShimmer() : data(controller, active),
                  ],
                ),
              )),
    );
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: controller.incomeList[index].note == ''
                                ...
                                : Text(controller.incomeList[index].note.toString(),
                                    style: const TextStyle(
                                      fontSize: 14,
                                    )),
                          ),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: controller.expenseList[index].note == ''
                                ...
                                : Text(controller.expenseList[index].note.toString(),
                                    style: const TextStyle(
                                      fontSize: 14,
                                    )),
                          ),
