...
//     // print(">>pick up ${dashboardController.pickupFromFsSpots.value!.pickupAssign!.length}");
...
//                                       child: dashboard.pickupFromFsSpots.value!.pickupAssign!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
...
//                                                   itemCount: dashboard.pickupFromFsSpots.value!.pickupAssign!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
...
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.pickupFromFsSpots.value!.pickupAssign![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
...
//                                                                             width: 150.w,
//                                                                             child: Text(
//                                                                               dashboard.pickupFromFsSpots.value!.pickupAssign![index].customerName.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w500,
//                                                                                 fontSize: 14,
//                                                                                 color: nameColor,
...
//                                                                           InkWell(
//                                                                             onTap: () {
//                                                                               showPickUpPopUp(dashboard.pickupFromFsSpots.value!.pickupAssign![index]);
//                                                                             },
//                                                                             child: SizedBox(
//                                                                               height: 35.h,
//                                                                               child: Card(
...
//                                                                       Row(children: [
//                                                                         Text(
//                                                                           dashboard.pickupFromFsSpots.value!.pickupAssign![index].customerPhone.toString(),
//                                                                           style: const TextStyle(
...
//                                                                         ),
//                                                                         TextButton(
//                                                                           onPressed: () => launchURL(dashboard.pickupFromFsSpots.value!.pickupAssign![index].customerPhone.toString()),
...
//                                                                             width: 200.w,
//                                                                             child: Text(
//                                                                               dashboard.pickupFromFsSpots.value!.pickupAssign![index].customerAddress.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w400,
//                                                                                 fontSize: 12,
//                                                                                 color: hintColor,
...
//                                                                             onPressed: () {
//                                                                               var url =
//                                                                                   'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.pickupFromFsSpots.value!.pickupAssign![index].customerAddress.toString()}&travelmode=driving';
...
//                                                                         children: [
//                                                                           Text(
//                                                                             '${Get.find<GlobalController>().currency!}${dashboard.pickupFromFsSpots.value!.pickupAssign![index].cashCollection.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                           SizedBox(width: 6),
//                                                                           Text(
//                                                                             '${dashboard.pickupFromFsSpots.value!.pickupAssign![index].statusName.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                       padding: const EdgeInsets.only(bottom: 250),
//                                       height: MediaQuery.of(context).size.height / 1.0,
//                                       child: dashboard.pickupFromFsSpots.value!.deliverymanAssign!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
//                                               style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
...
//                                               },
//                                               child: ListView.builder(
//                                                   itemCount: dashboard.pickupFromFsSpots.value!.deliverymanAssign!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
//                                                   itemBuilder: (BuildContext context, int index) {
//                                                     return InkWell(
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.pickupFromFsSpots.value!.deliverymanAssign![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
//                                                         padding: const EdgeInsets.only(bottom: 14.0),
...
//                                                                             width: 150.w,
//                                                                             child: Text(
//                                                                               dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].customerName.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w500,
//                                                                                 fontSize: 14,
//                                                                                 color: nameColor,
...
//                                                                           InkWell(
//                                                                             onTap: () {
//                                                                               if (dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].status == 7 || dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].status == 8) {
//                                                                                 collectByDriverPopUp(dashboard.pickupFromFsSpots.value!.deliverymanAssign![index]);
//                                                                               } else {
//                                                                                 showStatusPopUp(dashboard.pickupFromFsSpots.value!.deliverymanAssign![index]);
//                                                                               }
//                                                                             },
//                                                                             child: SizedBox(
//                                                                               height: 35.h,
...
//                                                                       Row(children: [
//                                                                         Text(
//                                                                           dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].customerPhone.toString(),
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 14,
//                                                                             color: hintColor,
...
//                                                                         ),
//                                                                         TextButton(
//                                                                           onPressed: () => launchURL(dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].customerPhone.toString()),
//                                                                           style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                           child: Row(
//                                                                             children: [
//                                                                               Icon(
...
//                                                                             width: 200.w,
//                                                                             child: Text(
//                                                                               dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].customerAddress.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w400,
//                                                                                 fontSize: 12,
//                                                                                 color: hintColor,
...
//                                                                             onPressed: () {
//                                                                               var url =
//                                                                                   'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].customerAddress.toString()}&travelmode=driving';
//                                                                               launchMapURL(Uri.parse(url));
//                                                                             },
//                                                                             style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                             child: Row(
...
//                                                                         children: [
//                                                                           Text(
//                                                                             '${Get.find<GlobalController>().currency!}${dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].cashCollection.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                           SizedBox(width: 6),
//                                                                           Text(
//                                                                             '${dashboard.pickupFromFsSpots.value!.deliverymanAssign![index].statusName.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                       child: dashboard.pickupFromFsSpots.value!.delivered!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
//                                               style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
...
//                                               },
//                                               child: ListView.builder(
//                                                   itemCount: dashboard.pickupFromFsSpots.value!.delivered!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
//                                                   itemBuilder: (BuildContext context, int index) {
//                                                     return InkWell(
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.pickupFromFsSpots.value!.delivered![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
//                                                         padding: const EdgeInsets.only(bottom: 14.0),
...
//                                                                   children: [
//                                                                     Text(
//                                                                       dashboard.pickupFromFsSpots.value!.delivered![index].customerName.toString(),
//                                                                       style: const TextStyle(
//                                                                         fontWeight: FontWeight.w500,
//                                                                         fontSize: 14,
//                                                                         color: nameColor,
...
//                                                                     Row(children: [
//                                                                       Text(
//                                                                         dashboard.pickupFromFsSpots.value!.delivered![index].customerPhone.toString(),
//                                                                         style: const TextStyle(
//                                                                           fontWeight: FontWeight.w400,
//                                                                           fontSize: 14,
//                                                                           color: hintColor,
...
//                                                                       ),
//                                                                       TextButton(
//                                                                         onPressed: () => launchURL(dashboard.pickupFromFsSpots.value!.delivered![index].customerPhone.toString()),
//                                                                         style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                         child: Row(
//                                                                           children: [
//                                                                             Icon(
...
//                                                                           width: 200.w,
//                                                                           child: Text(
//                                                                             dashboard.pickupFromFsSpots.value!.delivered![index].customerAddress.toString(),
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                         TextButton(
//                                                                           onPressed: () {
//                                                                             var url = 'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.pickupFromFsSpots.value!.delivered![index].customerAddress.toString()}&travelmode=driving';
//                                                                             launchMapURL(Uri.parse(url));
//                                                                           },
//                                                                           style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                           child: Row(
...
//                                                                       children: [
//                                                                         Text(
//                                                                           '${Get.find<GlobalController>().currency!}${dashboard.pickupFromFsSpots.value!.delivered![index].cashCollection.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
...
//                                                                         SizedBox(width: 6),
//                                                                         Text(
//                                                                           '${dashboard.pickupFromFsSpots.value!.delivered![index].statusName.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
...
//                                       padding: const EdgeInsets.only(bottom: 250),
//                                       height: MediaQuery.of(context).size.height / 1.0,
//                                       child: dashboard.pickupFromFsSpots.value!.returnToCourier!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
//                                               style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
...
//                                               },
//                                               child: ListView.builder(
//                                                   itemCount: dashboard.pickupFromFsSpots.value!.returnToCourier!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
//                                                   itemBuilder: (BuildContext context, int index) {
//                                                     return InkWell(
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.pickupFromFsSpots.value!.returnToCourier![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
//                                                         padding: const EdgeInsets.only(bottom: 14.0),
...
//                                                                   children: [
//                                                                     Text(
//                                                                       dashboard.pickupFromFsSpots.value!.returnToCourier![index].customerName.toString(),
//                                                                       style: const TextStyle(
//                                                                         fontWeight: FontWeight.w500,
//                                                                         fontSize: 14,
//                                                                         color: nameColor,
...
//                                                                     Row(children: [
//                                                                       Text(
//                                                                         dashboard.pickupFromFsSpots.value!.returnToCourier![index].customerPhone.toString(),
//                                                                         style: const TextStyle(
//                                                                           fontWeight: FontWeight.w400,
//                                                                           fontSize: 14,
//                                                                           color: hintColor,
...
//                                                                       ),
//                                                                       TextButton(
//                                                                         onPressed: () => launchURL(dashboard.pickupFromFsSpots.value!.returnToCourier![index].customerPhone.toString()),
//                                                                         style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                         child: Row(
//                                                                           children: [
//                                                                             Icon(
...
//                                                                           width: 200.w,
//                                                                           child: Text(
//                                                                             dashboard.pickupFromFsSpots.value!.returnToCourier![index].customerAddress.toString(),
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                           onPressed: () {
//                                                                             var url =
//                                                                                 'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.pickupFromFsSpots.value!.returnToCourier![index].customerAddress.toString()}&travelmode=driving';
//                                                                             launchMapURL(Uri.parse(url));
//                                                                           },
//                                                                           style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                           child: Row(
...
//                                                                       children: [
//                                                                         Text(
//                                                                           '${Get.find<GlobalController>().currency!}${dashboard.pickupFromFsSpots.value!.returnToCourier![index].cashCollection.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
...
//                                                                         SizedBox(width: 6),
//                                                                         Text(
//                                                                           '${dashboard.pickupFromFsSpots.value!.returnToCourier![index].statusName.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
