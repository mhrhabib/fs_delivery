...
//                   ),
//                 )
//               : dashboard.fsSpotsShipment.value!.deliverymanAssign!.length == 0
//                   ? Container()
//                   : Align(
...
//                                       child: dashboard.fsSpotsShipment.value!.pickupAssign!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
...
//                                                   itemCount: dashboard.fsSpotsShipment.value!.pickupAssign!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
...
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.fsSpotsShipment.value!.pickupAssign![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
...
//                                                                             width: 150.w,
//                                                                             child: Text(
//                                                                               dashboard.fsSpotsShipment.value!.pickupAssign![index].customerName.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w500,
//                                                                                 fontSize: 14,
//                                                                                 color: nameColor,
...
//                                                                           InkWell(
//                                                                             onTap: () {
//                                                                               showPickUpPopUp(dashboard.fsSpotsShipment.value!.pickupAssign![index]);
//                                                                             },
//                                                                             child: SizedBox(
//                                                                               height: 35.h,
//                                                                               child: Card(
...
//                                                                       Row(children: [
//                                                                         Text(
//                                                                           dashboard.fsSpotsShipment.value!.pickupAssign![index].customerPhone.toString(),
//                                                                           style: const TextStyle(
...
//                                                                         ),
//                                                                         TextButton(
//                                                                           onPressed: () => launchURL(dashboard.fsSpotsShipment.value!.pickupAssign![index].customerPhone.toString()),
...
//                                                                             width: 200.w,
//                                                                             child: Text(
//                                                                               dashboard.fsSpotsShipment.value!.pickupAssign![index].customerAddress.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w400,
//                                                                                 fontSize: 12,
//                                                                                 color: hintColor,
...
//                                                                             onPressed: () {
//                                                                               var url =
//                                                                                   'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.fsSpotsShipment.value!.pickupAssign![index].customerAddress.toString()}&travelmode=driving';
...
//                                                                         children: [
//                                                                           Text(
//                                                                             '${Get.find<GlobalController>().currency!}${dashboard.fsSpotsShipment.value!.pickupAssign![index].cashCollection.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                           SizedBox(width: 6),
//                                                                           Text(
//                                                                             '${dashboard.fsSpotsShipment.value!.pickupAssign![index].statusName.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                       padding: const EdgeInsets.only(bottom: 250),
//                                       height: MediaQuery.of(context).size.height / 1.0,
//                                       child: dashboard.fsSpotsShipment.value!.deliverymanAssign!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
//                                               style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
...
//                                               },
//                                               child: ListView.builder(
//                                                   itemCount: dashboard.fsSpotsShipment.value!.deliverymanAssign!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
//                                                   itemBuilder: (BuildContext context, int index) {
//                                                     return InkWell(
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.fsSpotsShipment.value!.deliverymanAssign![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
//                                                         padding: const EdgeInsets.only(bottom: 14.0),
...
//                                                                             width: 150.w,
//                                                                             child: Text(
//                                                                               dashboard.fsSpotsShipment.value!.deliverymanAssign![index].customerName.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w500,
//                                                                                 fontSize: 14,
//                                                                                 color: nameColor,
...
//                                                                             onTap: () {
//                                                                               // Get.back();
//                                                                               if (dashboard.fsSpotsShipment.value!.deliverymanAssign![index].status == 7 || dashboard.fsSpotsShipment.value!.deliverymanAssign![index].status == 8) {
//                                                                                 collectByDriverPopUp(dashboard.fsSpotsShipment.value!.deliverymanAssign![index]);
//                                                                               } else {
//                                                                                 showStatusPopUp(dashboard.fsSpotsShipment.value!.deliverymanAssign![index]);
//                                                                               }
//                                                                             },
//                                                                             child: SizedBox(
//                                                                               height: 35.h,
...
//                                                                       Row(children: [
//                                                                         Text(
//                                                                           dashboard.fsSpotsShipment.value!.deliverymanAssign![index].customerPhone.toString(),
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 14,
//                                                                             color: hintColor,
...
//                                                                         ),
//                                                                         TextButton(
//                                                                           onPressed: () => launchURL(dashboard.fsSpotsShipment.value!.deliverymanAssign![index].customerPhone.toString()),
//                                                                           style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                           child: Row(
//                                                                             children: [
//                                                                               Icon(
...
//                                                                             width: 200.w,
//                                                                             child: Text(
//                                                                               dashboard.fsSpotsShipment.value!.deliverymanAssign![index].customerAddress.toString(),
//                                                                               style: const TextStyle(
//                                                                                 fontWeight: FontWeight.w400,
//                                                                                 fontSize: 12,
//                                                                                 color: hintColor,
...
//                                                                             onPressed: () {
//                                                                               var url =
//                                                                                   'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.fsSpotsShipment.value!.deliverymanAssign![index].customerAddress.toString()}&travelmode=driving';
//                                                                               launchMapURL(Uri.parse(url));
//                                                                             },
//                                                                             style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                             child: Row(
...
//                                                                         children: [
//                                                                           Text(
//                                                                             '${Get.find<GlobalController>().currency!}${dashboard.fsSpotsShipment.value!.deliverymanAssign![index].cashCollection.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                           SizedBox(width: 6),
//                                                                           Text(
//                                                                             '${dashboard.fsSpotsShipment.value!.deliverymanAssign![index].statusName.toString()}',
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                       child: dashboard.fsSpotsShipment.value!.delivered!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
//                                               style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
...
//                                               },
//                                               child: ListView.builder(
//                                                   itemCount: dashboard.fsSpotsShipment.value!.delivered!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
//                                                   itemBuilder: (BuildContext context, int index) {
//                                                     return InkWell(
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.fsSpotsShipment.value!.delivered![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
//                                                         padding: const EdgeInsets.only(bottom: 14.0),
...
//                                                                   children: [
//                                                                     Text(
//                                                                       dashboard.fsSpotsShipment.value!.delivered![index].customerName.toString(),
//                                                                       style: const TextStyle(
//                                                                         fontWeight: FontWeight.w500,
//                                                                         fontSize: 14,
//                                                                         color: nameColor,
...
//                                                                     Row(children: [
//                                                                       Text(
//                                                                         dashboard.fsSpotsShipment.value!.delivered![index].customerPhone.toString(),
//                                                                         style: const TextStyle(
//                                                                           fontWeight: FontWeight.w400,
//                                                                           fontSize: 14,
//                                                                           color: hintColor,
...
//                                                                       ),
//                                                                       TextButton(
//                                                                         onPressed: () => launchURL(dashboard.fsSpotsShipment.value!.delivered![index].customerPhone.toString()),
//                                                                         style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                         child: Row(
//                                                                           children: [
//                                                                             Icon(
...
//                                                                           width: 200.w,
//                                                                           child: Text(
//                                                                             dashboard.fsSpotsShipment.value!.delivered![index].customerAddress.toString(),
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                         TextButton(
//                                                                           onPressed: () {
//                                                                             var url = 'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.fsSpotsShipment.value!.delivered![index].customerAddress.toString()}&travelmode=driving';
//                                                                             launchMapURL(Uri.parse(url));
//                                                                           },
//                                                                           style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                           child: Row(
...
//                                                                       children: [
//                                                                         Text(
//                                                                           '${Get.find<GlobalController>().currency!}${dashboard.fsSpotsShipment.value!.delivered![index].cashCollection.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
...
//                                                                         SizedBox(width: 6),
//                                                                         Text(
//                                                                           '${dashboard.fsSpotsShipment.value!.delivered![index].statusName.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
...
//                                       padding: const EdgeInsets.only(bottom: 250),
//                                       height: MediaQuery.of(context).size.height / 1.0,
//                                       child: dashboard.fsSpotsShipment.value!.returnToCourier!.length == 0
//                                           ? Center(
//                                               child: Text(
//                                               'no_item_found'.tr,
//                                               style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
...
//                                               },
//                                               child: ListView.builder(
//                                                   itemCount: dashboard.fsSpotsShipment.value!.returnToCourier!.length,
//                                                   shrinkWrap: true,
//                                                   padding: EdgeInsets.zero,
//                                                   itemBuilder: (BuildContext context, int index) {
//                                                     return InkWell(
//                                                       onTap: () {
//                                                         setState(() {
//                                                           showPopUp(dashboard.fsSpotsShipment.value!.returnToCourier![index]);
//                                                         });
//                                                       },
//                                                       child: Padding(
//                                                         padding: const EdgeInsets.only(bottom: 14.0),
...
//                                                                   children: [
//                                                                     Text(
//                                                                       dashboard.fsSpotsShipment.value!.returnToCourier![index].customerName.toString(),
//                                                                       style: const TextStyle(
//                                                                         fontWeight: FontWeight.w500,
//                                                                         fontSize: 14,
//                                                                         color: nameColor,
...
//                                                                     Row(children: [
//                                                                       Text(
//                                                                         dashboard.fsSpotsShipment.value!.returnToCourier![index].customerPhone.toString(),
//                                                                         style: const TextStyle(
//                                                                           fontWeight: FontWeight.w400,
//                                                                           fontSize: 14,
//                                                                           color: hintColor,
...
//                                                                       ),
//                                                                       TextButton(
//                                                                         onPressed: () => launchURL(dashboard.fsSpotsShipment.value!.returnToCourier![index].customerPhone.toString()),
//                                                                         style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                         child: Row(
//                                                                           children: [
//                                                                             Icon(
...
//                                                                           width: 200.w,
//                                                                           child: Text(
//                                                                             dashboard.fsSpotsShipment.value!.returnToCourier![index].customerAddress.toString(),
//                                                                             style: const TextStyle(
//                                                                               fontWeight: FontWeight.w400,
//                                                                               fontSize: 12,
//                                                                               color: hintColor,
...
//                                                                           onPressed: () {
//                                                                             var url =
//                                                                                 'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.fsSpotsShipment.value!.returnToCourier![index].customerAddress.toString()}&travelmode=driving';
//                                                                             launchMapURL(Uri.parse(url));
//                                                                           },
//                                                                           style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size(50, 30), tapTargetSize: MaterialTapTargetSize.shrinkWrap, alignment: Alignment.centerLeft),
//                                                                           child: Row(
...
//                                                                       children: [
//                                                                         Text(
//                                                                           '${Get.find<GlobalController>().currency!}${dashboard.fsSpotsShipment.value!.returnToCourier![index].cashCollection.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
...
//                                                                         SizedBox(width: 6),
//                                                                         Text(
//                                                                           '${dashboard.fsSpotsShipment.value!.returnToCourier![index].statusName.toString()}',
//                                                                           style: const TextStyle(
//                                                                             fontWeight: FontWeight.w400,
//                                                                             fontSize: 12,
//                                                                             color: hintColor,
