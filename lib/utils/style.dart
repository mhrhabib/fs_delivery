...
final fontBoldWithColor = TextStyle(fontFamily: 'Rubik', fontWeight: FontWeight.w600, fontSize: Dimensions.fontSizeExtraLarge.sp, color: kMainColor);
...
final fontProfile = TextStyle(fontFamily: 'Rubik', fontSize: 15, fontWeight: FontWeight.w500, color: fontColor);
